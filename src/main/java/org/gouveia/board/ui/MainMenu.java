...
import org.gouveia.board.service.BoardService;
...
import static org.gouveia.board.persistence.entity.BoardColumnKindEnum.*;
    ...
    private void selectBoard() throws SQLException {
        ...
        try (var connection = getConnection()) {
            ...
            optional.ifPresentOrElse(
                    ...
                    () -> System.out.printf("Não foi encontado o board com o id %s.\n", id)
            );
        }
    }
